...
int CALLBACK FolderSelectDialog::BrowseCallbackProc(HWND, UINT, LPARAM, LPARAM) { return 0; }

FolderSelectDialog::FolderSelectDialog(HWND, const char *Title, const char *InitialFolder) :
	m_Title(Title ? Title : ""),
...
FolderSelectDialog::Result FolderSelectDialog::DoModal() { return Result::Cancel; }

std::string FolderSelectDialog::GetFolder() const { return m_Buffer; }
